        ...
        <section id="section">
            <div>
                <div class="pai">
                    ...
                    <div class="body">
                        <div class="cade_body">
                            <i class="fa fa-window-close" aria-hidden="true" onclick="rediclose()"></i>
                        </div>
                        <div class="body_body">
                            <textarea id="msg" readonly=“true”><?php echo $_SESSION['inv_log_root']; echo $_SESSION['log_help_root'] ?></textarea>
                            <input type="text" placeholder="  c:>" readonly=“true”>
                            <form method="POST" action="log_root.php">
                                <input name="barra" type="text" require maxlength="50" autocomplete="off" autofocus>
                            </form>
                        </div>
                    </div>
                </div>
